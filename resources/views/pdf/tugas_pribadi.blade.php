...
<html>
<head>
	<title>output surat tugas</title>
	<style type="text/css">
		table {
			border-style: double;
			border-width: 3px;
...
<body>
	<center>
		...
		<table width="625">
			<tr>
		       <td>
			       <font size="2"><br>Dengan ini Dekan Fakultas teknologi Informasi Universitas Kristen Duta Wacana memberikan tugas kepada {{ $item->pengirim->nama }} ;</font>
		       </td>
		    </tr>
		</table>
        <table width="625">
